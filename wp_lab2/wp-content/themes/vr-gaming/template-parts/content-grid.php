        ...
        <?php foreach ($vr_gaming_archive_element_sortable as $value) : ?>
            ...
            <?php if ($value === 'option2') : ?>
                <div class="post-meta my-3">
                    ...
                    <span><?php echo esc_html(vr_gaming_edit_link()); ?></span>
                </div>
            <?php endif; ?>
            ...
            <?php if ($value === 'option4') : ?>
                <div class="post-content mb-2">
                    <?php echo wp_trim_words(get_the_content(), get_theme_mod('vr_gaming_post_excerpt_number', 10)); ?>
                </div>
            <?php endif; ?>

            <?php if ($value === 'option5') : ?>
              <div class="more-btn mt-4 mb-4">
                <a class="p-1" href="<?php the_permalink(); ?>"><?php esc_html_e( 'Read More', 'vr-gaming' ); ?><span><i class="fas fa-long-arrow-alt-right"></i></span></a>
              </div>
            <?php endif; ?>
        <?php endforeach; ?>
    </div>
